...
/**
*/
class TestCorpus82XF  {

  File tiFile = new File("testdata/82xf/franktextinventory.xml")
  File confFile = new File("testdata/82xf/franktextconfig.xml")
  File baseDir = new File("testdata/82xf/archive")
